...
- **Leaf 24:** nothing to promote (standalone — imports neither core module nor a sibling leaf; needs no
  ...
  *liveness* property** (most are safety facts with a *finite* witness; leaf 19 unlinkability / leaf 22
  knowledge-soundness are *hyperproperties*, not trace properties at all); `arq-types` is the first
