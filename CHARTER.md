...
thesis**, and that is the entry worth reading twice. The swap is load-bearing (∥ pow, ecash) on **all four**
properties this construction needs — the toy failed every one, though only three are supplied
