...
a value, not of the value — does not, proved as `pow_effort_not_witness_definable` (two executions, one
witness, different effort ⟹ no `Witness → effort` function). The probabilistic work bound stays discharged
