...
for the honest prover turned into the protocol's soundness proof). Corona
...
- *(None scheduled. The **vocabulary is complete** (leaf 6), **composition is
  ...
  **Every named breadth candidate is built, and the two sibling gardens are both wired to
  ...
  two security properties both escape the vocabulary). Leaves 16–22 are all *unscheduled* open-ended
